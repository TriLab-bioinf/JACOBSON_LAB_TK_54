...
Goal: to utilize a published RNA seq dataset for extracting information about the expression of some genes which are relevant to my project, mainly the purinergic receptors expression (P2Y, P2X and adenosine receptors) in mouse.
...
```{r}
# 6. Cluster cells --------
gse <- FindNeighbors(gse, dims = 1:4)
